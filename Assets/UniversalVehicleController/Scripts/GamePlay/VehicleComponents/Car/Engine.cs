...
namespace PG
{
    ...
    public partial class CarController :VehicleController
    {
        ...
        public void UpdateBlockControl(bool control)
        {
            ...
            if (BlockControl) MyGameController.instance.MyManager.carLambRigidbody.drag = 100;
            else MyGameController.instance.MyManager.carLambRigidbody.drag = 0.02f;
        }
        ...
        void FixedUpdateEngine ()
        {
            ...
            {
                CurrentAcceleration = InBoost ? 1 : CarControl.Acceleration;
            ...
            //Boost logic
            InBoost = Engine.EnableBoost && CarControl != null && (CarControl.Boost || MyGameController.instance.MyManager.nitro) && BoostAmount > 0 && !BlockControl;
            ...
            {
                MyGameController.instance.MyManager.nitro = false;
            }
        }
